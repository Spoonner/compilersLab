...
public final class TokenScanner {
    ...
    /**
     * KEYWORD MAP STATIC INITIALIZE SECTION
     */
    ...
    /**
     * OPERATORS TOKEN STATIC INITIALIZE SECTION
     */
    ...
    /**
     * CHAR STATIC INITIALIZE SECTION
     */
    ...
    static {
        ...
        for (int i = 33; i < 48; i++) {
            String curretChar = String.valueOf(Character.toChars(i)[0]);
            CHAR_TYPE.put(curretChar, TYPE.LETTER);
        }
