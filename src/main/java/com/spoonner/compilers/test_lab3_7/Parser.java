...
public final class Parser {
    enum TYPE {
        INTEGER, REAL, BOOLEAN, CHAR, STRING, PROCEDURE, LABEL, ARRAY     // integer, real, boolean, char, string, procedure, label, array
    }
    ...
    static {
        ...
        STRING_TYPE_HASH_MAP.put("integer", TYPE.INTEGER);
        STRING_TYPE_HASH_MAP.put("real", TYPE.REAL);
        STRING_TYPE_HASH_MAP.put("boolean", TYPE.BOOLEAN);
        STRING_TYPE_HASH_MAP.put("char", TYPE.CHAR);
        STRING_TYPE_HASH_MAP.put("string", TYPE.STRING);
        STRING_TYPE_HASH_MAP.put("array", TYPE.ARRAY);
                ...
                case INTEGER:
                    ...
                    for (Token var : variablesArrayList) {
                        ...
                        if (symbol != null) {
                            ...
                            symbol.setIndexType(TYPE.INTEGER);
        ...
        switch (op) {
            case "TK_PLUS":
                if (t1 == TYPE.INTEGER && t2 == TYPE.INTEGER) {
                    ...
                    return TYPE.REAL;
                } else if (t1 == TYPE.REAL && t2 == TYPE.INTEGER) {
                    genOpCode(OP_CODE.CVR);
                    genOpCode(OP_CODE.FADD);
                    return TYPE.REAL;
